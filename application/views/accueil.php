...
<html>
<head>
	<title>Site d'Information sur le covid-19 | Template Stock</title>
	<!-- Bootstrap CSS -->
</head>
<body>
<!-- Services -->
	...
	<div class="row">
		<div class="col-md-4 about-us-box wow fadeInUp animated">
		    <div class="about-us-photo">
		    	<img src=<?php echo(site_url("images/1.jpg")); ?> alt="">
		...
		<div class="col-md-4 about-us-box wow fadeInUp animated">
		    <div class="about-us-photo">
		    	<img src=<?php echo(site_url("images/2.jpg")); ?> alt="">
		    	<div class="about-us-role">Marketing</div>
		    </div>
		    <h3>John Doe</h3>
		    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
		...
		<div class="col-md-4 about-us-box wow fadeInUp animated">
		    <div class="about-us-photo">
		    	<img src=<?php echo(site_url("images/3.jpg")); ?> alt="">
		    	<div class="about-us-role">Marketing</div>
		    </div>
		    <h3>John Doe</h3>
		    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p>
